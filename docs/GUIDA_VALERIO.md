...
6. In cima c'è la riga **"Sempre"**: le caselle messe lì restano visibili in ogni
   fase, sopra la barra dei comandi (per i suoni che servono tutta la sera).
7. Per ogni fase, aggiungi le caselle dei suoni. Trascina i file audio sopra le
...
- Sui pulsanti che suonano vedi **"finisce tra 0:42"**: negli ultimi 10 secondi
  il numero diventa ambra, così sai quando prepararti.
